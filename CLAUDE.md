...
test asserts. It ships 32 Roslyn analyzers (`JD001`–`JD032`) inside its own package.
...
capped at a million (ADR-0076, superseding ADR-0029), floating-point draws within an ordinary magnitude (ADR-0031).
