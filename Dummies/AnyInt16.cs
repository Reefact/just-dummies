...
/// </summary>
public sealed class AnyInt16 : IAny<short>, IHasRandomSource, ICardinalityHint, IDomainMembership<short> {
    ...
    bool IDomainMembership<short>.Contains(short value) => _spec.Contains(Ord(value));

    /// <summary>Requires a value strictly greater than zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingAnyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public AnyInt16 Positive() {
        return new AnyInt16(_source, _spec.WithMinimum(Ord(1), "Positive()"));
    }
    ...
    public AnyInt16 Negative() {
        return new AnyInt16(_source, _spec.WithMaximum(Ord(-1), "Negative()"));
    }
    ...
    public AnyInt16 Zero() {
        return new AnyInt16(_source, _spec.WithMinimum(Ord(0), "Zero()").WithMaximum(Ord(0), "Zero()"));
    }
    ...
    public AnyInt16 NonZero() {
        return new AnyInt16(_source, _spec.WithExcluded([Ord(0)], "NonZero()"));
    }
    ...
    public AnyInt16 GreaterThan(short value) {
        return new AnyInt16(_source, _spec.WithMinimumAbove(Ord(value), $"GreaterThan({V(value)})"));
    }
    ...
    public AnyInt16 GreaterThanOrEqualTo(short value) {
        return new AnyInt16(_source, _spec.WithMinimum(Ord(value), $"GreaterThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyInt16 LessThan(short value) {
        return new AnyInt16(_source, _spec.WithMaximumBelow(Ord(value), $"LessThan({V(value)})"));
    }
    ...
    public AnyInt16 LessThanOrEqualTo(short value) {
        return new AnyInt16(_source, _spec.WithMaximum(Ord(value), $"LessThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyInt16 OneOf(params short[] values) {
        ...
        return new AnyInt16(_source, _spec.WithAllowed(values.Select(Ord).ToArray(), $"OneOf({Join(values)})"));
    }
    ...
    public AnyInt16 Except(params short[] values) {
        ...
        return new AnyInt16(_source, _spec.WithExcluded(values.Select(Ord).ToArray(), $"Except({Join(values)})"));
    }
    ...
    public AnyInt16 DifferentFrom(short value) {
        return new AnyInt16(_source, _spec.WithExcluded([Ord(value)], $"DifferentFrom({V(value)})"));
    }
