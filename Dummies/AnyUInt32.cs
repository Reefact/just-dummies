...
/// </summary>
public sealed class AnyUInt32 : IAny<uint>, IHasRandomSource, ICardinalityHint {
    ...
    public AnyUInt32 Zero() {
        return new AnyUInt32(_source, _spec.WithMinimum(Ord(0), "Zero()").WithMaximum(Ord(0), "Zero()"));
    }
    ...
    public AnyUInt32 NonZero() {
        return new AnyUInt32(_source, _spec.WithExcluded([Ord(0)], "NonZero()"));
    }
    ...
    public AnyUInt32 GreaterThan(uint value) {
        return new AnyUInt32(_source, _spec.WithMinimumAbove(Ord(value), $"GreaterThan({V(value)})"));
    }
    ...
    public AnyUInt32 GreaterThanOrEqualTo(uint value) {
        return new AnyUInt32(_source, _spec.WithMinimum(Ord(value), $"GreaterThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyUInt32 LessThan(uint value) {
        return new AnyUInt32(_source, _spec.WithMaximumBelow(Ord(value), $"LessThan({V(value)})"));
    }
    ...
    public AnyUInt32 LessThanOrEqualTo(uint value) {
        return new AnyUInt32(_source, _spec.WithMaximum(Ord(value), $"LessThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyUInt32 OneOf(params uint[] values) {
        ...
        return new AnyUInt32(_source, _spec.WithAllowed(values.Select(Ord).ToArray(), $"OneOf({Join(values)})"));
    }
    ...
    public AnyUInt32 Except(params uint[] values) {
        ...
        return new AnyUInt32(_source, _spec.WithExcluded(values.Select(Ord).ToArray(), $"Except({Join(values)})"));
    }
    ...
    public AnyUInt32 DifferentFrom(uint value) {
        return new AnyUInt32(_source, _spec.WithExcluded([Ord(value)], $"DifferentFrom({V(value)})"));
    }
