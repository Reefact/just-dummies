...
/// </summary>
public sealed class AnyUInt32 : IAny<uint>, IHasRandomSource, ICardinalityHint, IDomainMembership<uint> {
    ...
    bool IDomainMembership<uint>.Contains(uint value) => _spec.Contains(Ord(value));
