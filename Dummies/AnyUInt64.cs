...
/// </summary>
public sealed class AnyUInt64 : IAny<ulong>, IHasRandomSource, ICardinalityHint, IDomainMembership<ulong> {
    ...
    bool IDomainMembership<ulong>.Contains(ulong value) => _spec.Contains(Ord(value));
    ...
    public AnyUInt64 Zero() {
        return new AnyUInt64(_source, _spec.WithMinimum(Ord(0), "Zero()").WithMaximum(Ord(0), "Zero()"));
    }
    ...
    public AnyUInt64 NonZero() {
        return new AnyUInt64(_source, _spec.WithExcluded([Ord(0)], "NonZero()"));
    }
    ...
    public AnyUInt64 GreaterThan(ulong value) {
        return new AnyUInt64(_source, _spec.WithMinimumAbove(Ord(value), $"GreaterThan({V(value)})"));
    }
    ...
    public AnyUInt64 GreaterThanOrEqualTo(ulong value) {
        return new AnyUInt64(_source, _spec.WithMinimum(Ord(value), $"GreaterThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyUInt64 LessThan(ulong value) {
        return new AnyUInt64(_source, _spec.WithMaximumBelow(Ord(value), $"LessThan({V(value)})"));
    }
    ...
    public AnyUInt64 LessThanOrEqualTo(ulong value) {
        return new AnyUInt64(_source, _spec.WithMaximum(Ord(value), $"LessThanOrEqualTo({V(value)})"));
    }
    ...
    public AnyUInt64 OneOf(params ulong[] values) {
        ...
        return new AnyUInt64(_source, _spec.WithAllowed(values.Select(Ord).ToArray(), $"OneOf({Join(values)})"));
    }
    ...
    public AnyUInt64 Except(params ulong[] values) {
        ...
        return new AnyUInt64(_source, _spec.WithExcluded(values.Select(Ord).ToArray(), $"Except({Join(values)})"));
    }
    ...
    public AnyUInt64 DifferentFrom(ulong value) {
        return new AnyUInt64(_source, _spec.WithExcluded([Ord(value)], $"DifferentFrom({V(value)})"));
    }
