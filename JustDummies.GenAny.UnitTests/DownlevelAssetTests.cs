...
///     <c>Any.DateOnly()</c> from a table rather than from the compilation would hand a downlevel developer a
...
public sealed class DownlevelAssetTests {
    ...
    [InlineData("DateOnly", "Any.DateOnly()")]
    [InlineData("TimeOnly", "Any.TimeOnly()")]
    [InlineData("Int128", "Any.Int128()")]
    [InlineData("UInt128", "Any.UInt128()")]
    [InlineData("Half", "Any.Half()")]
