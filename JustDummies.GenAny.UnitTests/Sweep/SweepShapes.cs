...
using JustDummies.GenAny.UnitTests.Sweep;

using Collection = JustDummies.GenAny.UnitTests.Sweep.SweepAxes.Collection;
using Element = JustDummies.GenAny.UnitTests.Sweep.SweepAxes.Element;
using SizeGuard = JustDummies.GenAny.UnitTests.Sweep.SweepAxes.SizeGuard;
