...
internal enum Bound {
    ...
    /// <summary>A floor — <c>GreaterThanOrEqualTo</c>, <c>WithMinLength</c>, <c>WithMinCount</c>, <c>Positive</c>.</summary>
    Lower = 1,

    /// <summary>A ceiling — <c>LessThanOrEqualTo</c>, <c>WithMaxLength</c>, <c>WithMaxCount</c>, <c>Negative</c>.</summary>
    Upper = 2,
