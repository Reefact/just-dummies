...
/// </remarks>
[Flags]
[SuppressMessage(SonarRule.S2342.Category, SonarRule.S2342.Id,
                 Justification = "The specification names this concept in the singular (§6, \"provenance\"), and the "
                               + "property that carries it is Provenance; a plural type name would make every use site "
                               + "read `Provenances Provenance`.")]
