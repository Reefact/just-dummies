...
public static class TypeNaming {
    ...
    /// <summary>
    ///     The name of the generator emitted for <paramref name="type" /> — <c>AnyOrder</c> for <c>Order</c>.
    /// </summary>
    /// <remarks>
    ///     A nested type is named after itself alone: <c>Order.Line</c> emits a top-level <c>AnyLine</c> in the
