...
internal static class EmittedCodeCompiler {
    ...
    private const string Domain = """
                                  namespace Shop.Domain {
                                      ...
                                      // Already scaffolded, which is why DummyOrder composes them rather than leaving them open.
                                      public sealed class DummyCustomer : JustDummies.IDummy<Customer> {
                                          public Customer Generate() { return new Customer("name"); }
                                      }

                                      public sealed class DummyOrderReference : JustDummies.IDummy<OrderReference> {
                                  ...
                                  namespace Shop.Legacy {
                                      ...
                                      // The name that shadows JustDummies.DummyPattern once a generator is scaffolded for it.
    ...
    internal static CSharpCompilation CompileTogether(params string[] emitted) {
        return CSharpCompilation.Create(
            assemblyName: "JustDummies.GenDummy.Emitted",
