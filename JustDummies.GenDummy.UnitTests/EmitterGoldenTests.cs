...
public sealed class EmitterGoldenTests {
    ...
    public void SixParametersAllInferred() {
        GoldenFile.Approve("DummyOrder", GeneratorEmitter.Emit(Shapes.Order()).SourceText);
    }
    ...
    public void OneParameterLeftOpen() {
        ...
        GoldenFile.Approve("DummyOrderWithTodo", file.SourceText);
    ...
    public void TheSamePlanEmitsTheSameBytesInEveryCulture(string culture) {
        ...
        try {
            ...
            Check.That(GeneratorEmitter.Emit(Shapes.Order()).SourceText).IsEqualTo(GoldenFile.ApprovedTextOf("DummyOrder"));
        } finally {
