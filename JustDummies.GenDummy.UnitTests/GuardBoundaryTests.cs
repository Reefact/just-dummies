...
public sealed class GuardBoundaryTests {
    ...
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Split(',').Length < 2) { throw new ArgumentException(nameof(value)); }")]
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Trim().Length < 8) { throw new ArgumentException(nameof(value)); }")]
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Substring(2).Length > 10) { throw new ArgumentException(nameof(value)); }")]
    [InlineData("int", "Dummy.Int32()", "if (Math.Abs(value) > 90) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("int", "Dummy.Int32()", "if (value * 2 > 100) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("int", "Dummy.Int32()", "if (-value > 0) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("int", "Dummy.Int32()", "if ((long)value > 100) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("TimeSpan", "Dummy.TimeSpan()", "if (value.TotalMinutes < 5) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    ...
    [InlineData("double", "Dummy.Double()", "if (value > 1e30) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("double", "Dummy.Double()", "if (value > double.MaxValue) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("float", "Dummy.Single()", "if (value > 3.4e30f) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Length > 140.5) { throw new ArgumentException(nameof(value)); }")]
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Length > 3000000000) { throw new ArgumentException(nameof(value)); }")]
    [InlineData("string", "Dummy.String().NonEmpty()", "if (value.Length > -1) { throw new ArgumentException(nameof(value)); }")]
    ...
    /// </summary>
    /// <remarks>
    ///     The row's justification is that <c>Dummy.Enum&lt;E&gt;()</c> already draws declared members only —
    ...
    public void ParenthesesAroundTheSubjectLeaveTheGuardReadable(string guard) {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.String().WithMinLength(8)");
    ...
    public void AThrowingCheckAfterTheFirstAssignmentIsNotAGuard() {
        ...
        Check.That(outcome.Plan!.Parameters[0].Expression).IsEqualTo("Dummy.Int32()");
    }
    ...
    public void AGuardBelowAReassignmentOfItsParameterIsUnread() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Int32().GreaterThanOrEqualTo(0)");
        Check.That(parameter.Provenance.HasFlag(Provenance.Guard)).IsTrue();
        Check.That(parameter.Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
    ...
    public void AGuardBelowAReassignmentIsUnreadInEverySpelling(string reassignment) {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Int32()");
        Check.That(parameter.Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
    }
    ...
    public void AReassignmentEndsTheReadingForItsOwnParameterOnly() {
        ...
        Check.That(outcome.Plan!.Parameters[0].Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
        Check.That(outcome.Plan.Parameters[1].Expression).IsEqualTo("Dummy.String().WithMinLength(8)");
    ...
    [InlineData("        value = value.Trim();", "Dummy.String().NonEmpty()")]
    [InlineData("""
    ...
    public void AWriteThroughAnOutArgumentEndsTheReading() {
        ...
        Check.That(outcome.Plan!.Parameters[1].Expression).IsEqualTo("Dummy.Int32()");
        Check.That(outcome.Plan.Parameters[1].Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
    }
    ...
    [InlineData("Dummy.Int32()", true, """
                ...
                """)]
    [InlineData("Dummy.Int32().GreaterThanOrEqualTo(0)", false, """
                        try {
                        } finally {
                            ArgumentOutOfRangeException.ThrowIfNegative(value);
                        }
    ...
    public void AUsingResourceThatWritesEndsTheReading() {
        ...
        Check.That(writing.Plan!.Parameters[0].Expression).IsEqualTo("Dummy.Int32()");
        Check.That(writing.Plan.Parameters[0].Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();

        Check.That(quiet.Plan!.Parameters[0].Expression).IsEqualTo("Dummy.Int32().GreaterThanOrEqualTo(0)");
    ...
    [InlineData("Dummy.Int32()", true, "this(Normalize(ref value), true)")]
    [InlineData("Dummy.Int32()", true, "this(Normalize(out value), true)")]
    [InlineData("Dummy.Int32()", true, "this(ref value, true)")]
    [InlineData("Dummy.Int32()", true, "this(out value, \"\")")]
    [InlineData("Dummy.Int32().GreaterThanOrEqualTo(0)", false, "this(value, true)")]
    ...
    public void AGuardTheDelegatedConstructorReadsFoldsOntoThisOne() {
        ...
        Check.That(percent.Expression).IsEqualTo("Dummy.Int32().Positive().LessThanOrEqualTo(100)");
        Check.That(percent.Provenance.HasFlag(Provenance.UnreadGuards)).IsFalse();
        Check.That(other.Expression).IsEqualTo("Dummy.Int32()");
    ...
    public void AComputedInitializerArgumentDoesNotFoldTheDelegatedGuard() {
        ...
        Check.That(percent.Expression).IsEqualTo("Dummy.Int32()");
    ...
    ///     <c>Dummy.Int32().GreaterThanOrEqualTo(0)</c>, reported as inferred with nothing worth looking at,
    ...
    public void AConditionGatingOneHelperLeavesAnotherRead() {
        ...
        Check.That(outcome.Plan.Parameters[2].Expression).IsEqualTo("Dummy.Int32().GreaterThanOrEqualTo(0)");
    ...
    [InlineData("int", "CommunityToolkit.Diagnostics.Guard.IsBetween(value, 0, 100, nameof(value));", "Dummy.Int32()")]
    [InlineData("int", "CommunityToolkit.Diagnostics.Guard.IsGreaterThan(value, int.Parse(\"1\"), nameof(value));", "Dummy.Int32()")]
    ...
    public void AGuardAssignmentUnderAConditionIsMarked() {
        ...
        Check.That(value.Expression).IsEqualTo("Dummy.Int32()");
    ...
    public void AGuardAssignedBackToItsOwnParameterIsMarked() {
        ...
        Check.That(value.Expression).IsEqualTo("Dummy.String().NonEmpty()");
        Check.That(value.Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
