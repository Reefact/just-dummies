...
///     that claim is precise: <c>Dummy.String().As(OrderReference.Create)</c> — the chain a scaffolder gets
///     without this — threw <c>DummyGenerationException</c> 594 times in 10 000 draws, about one in seventeen.
/// </remarks>
public sealed class GuardReadingTests {

    [Theory(DisplayName = "A guard on a string is read into the string family.")]
    [InlineData("if (string.IsNullOrEmpty(value)) { throw new ArgumentException(nameof(value)); }", "Dummy.String().NonEmpty()")]
    [InlineData("if (string.IsNullOrWhiteSpace(value)) { throw new ArgumentException(nameof(value)); }", "Dummy.String().NotBlank()")]
    [InlineData("if (value.Length == 0) { throw new ArgumentException(nameof(value)); }", "Dummy.String().NonEmpty()")]
    [InlineData("if (value.Length < 1) { throw new ArgumentException(nameof(value)); }", "Dummy.String().NonEmpty()")]
    [InlineData("if (value.Length > 10) { throw new ArgumentException(nameof(value)); }", "Dummy.String().NonEmpty().WithMaxLength(10)")]
    [InlineData("if (value.Length < 3) { throw new ArgumentException(nameof(value)); }", "Dummy.String().WithMinLength(3)")]
    [InlineData("if (value.Length != 12) { throw new ArgumentException(nameof(value)); }", "Dummy.String().WithLength(12)")]
    ...
    [InlineData("int", "if (value <= 0) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().Positive()")]
    [InlineData("int", "if (value < 1) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().Positive()")]
    [InlineData("int", "if (value < 0) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().GreaterThanOrEqualTo(0)")]
    [InlineData("int", "if (value >= 0) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().Negative()")]
    [InlineData("int", "if (value == 0) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().NonZero()")]
    [InlineData("int", "if (value > 100) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().LessThanOrEqualTo(100)")]
    [InlineData("int", "if (value < 18) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int32().GreaterThanOrEqualTo(18)")]
    [InlineData("long", "if (value <= 0) { throw new ArgumentOutOfRangeException(nameof(value)); }", "Dummy.Int64().Positive()")]
    ...
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfNegative(value);", "Dummy.Int32().GreaterThanOrEqualTo(0)")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value);", "Dummy.Int32().Positive()")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfZero(value);", "Dummy.Int32().NonZero()")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfLessThan(value, 18);", "Dummy.Int32().GreaterThanOrEqualTo(18)")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfGreaterThan(value, 100);", "Dummy.Int32().LessThanOrEqualTo(100)")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfLessThanOrEqual(value, 0);", "Dummy.Int32().GreaterThan(0)")]
    [InlineData("int", "ArgumentOutOfRangeException.ThrowIfGreaterThanOrEqual(value, 100);", "Dummy.Int32().LessThan(100)")]
    [InlineData("decimal", "ArgumentOutOfRangeException.ThrowIfLessThan(value, 9.99m);", "Dummy.Decimal().GreaterThanOrEqualTo(9.99m)")]
    ...
    [InlineData("byte", "Dummy.Byte()", "ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value);")]
    [InlineData("uint", "Dummy.UInt32()", "ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value);")]
    [InlineData("ulong", "Dummy.UInt64()", "ArgumentOutOfRangeException.ThrowIfNegativeOrZero(value);")]
    [InlineData("ushort", "Dummy.UInt16()", "ArgumentOutOfRangeException.ThrowIfLessThan(value, 1);")]
    [InlineData("byte", "Dummy.Byte()", "if (value <= 0) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    [InlineData("uint", "Dummy.UInt32()", "if (value < 1) { throw new ArgumentOutOfRangeException(nameof(value)); }")]
    ...
    public void ThrowIfNegativeAndThrowIfNegativeOrZeroReadAsDifferentConstraints() {
        ...
        Check.That(admittingZero).IsEqualTo("Dummy.Int32().GreaterThanOrEqualTo(0)");
        Check.That(refusingZero).IsEqualTo("Dummy.Int32().Positive()");
    ...
    public void AGuardFollowedByAnElseIsReadTheSameAsOneWithNoElseAtAll() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Int32().Positive()");
        Check.That(parameter.Provenance.HasFlag(Provenance.Guard)).IsTrue();
    ...
    public void AnElseIfChainThatThrowsThroughoutReadsEveryBranchsOwnGuard() {
        ...
        Check.That(outcome.Plan!.Parameters[0].Expression).IsEqualTo("Dummy.Int32().Between(0, 100)");
    ...
    [InlineData("int", "Dummy.Int32().Positive()")]
    [InlineData("long", "Dummy.Int64().Positive()")]
    [InlineData("decimal", "Dummy.Decimal().GreaterThanOrEqualTo(1m)")]
    [InlineData("double", "Dummy.Double().GreaterThanOrEqualTo(1d)")]
    [InlineData("float", "Dummy.Single().GreaterThanOrEqualTo(1f)")]
    ...
    public void ADecimalBoundIsWrittenAsADecimalLiteral() {
        ...
        Check.That(Subject.GuardedBy("decimal", guard).Expression).IsEqualTo("Dummy.Decimal().LessThanOrEqualTo(9.99m)");
    }
    ...
    ///     (§5.4's old derivation path); since ADR-0089 a composed parameter is <c>new DummyTags()</c> and
    ...
    public void ACountReadOffANonCollectionNonStringParameterIsUnread() {
        ...
        Check.That(tags.Expression).IsEqualTo("new DummyTags()");
    ...
    [InlineData("string", "if (value is null) { throw new ArgumentNullException(nameof(value)); }", "Dummy.String().NonEmpty()")]
    [InlineData("string", "if (value == null) { throw new ArgumentNullException(nameof(value)); }", "Dummy.String().NonEmpty()")]
    ...
    public void AnEmptyGuidGuardIsReadAsNonEmpty() {
        ...
        Check.That(Subject.GuardedBy("Guid", guard).Expression).IsEqualTo("Dummy.Guid().NonEmpty()");
    }

    /// <summary>
    ///     An enum exclusion guard reads as <c>DummyEnum&lt;T&gt;.DifferentFrom</c> — the commonest enum guard
    ...
    public void AnEnumExclusionGuardIsReadAsDifferentFrom() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Enum<OrderStatus>().DifferentFrom(OrderStatus.Draft)");
        Check.That(parameter.Provenance.HasFlag(Provenance.Guard)).IsTrue();
        Check.That(parameter.Provenance.HasFlag(Provenance.UnreadGuards)).IsFalse();
    }
    ...
    public void AnEnumExclusionGuardIsReadTheSameOnANullableEnumParameter() {
        ...
        Check.That(parameter.Expression)
             .IsEqualTo("Dummy.Enum<OrderStatus>().DifferentFrom(OrderStatus.Draft).AsNullable()");
    }
    ...
    public void AnEnumEqualityGuardsNegationIsNotReadAsAnExclusion() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Enum<OrderStatus>()");
        Check.That(parameter.Provenance.HasFlag(Provenance.UnreadGuards)).IsTrue();
    }
    ...
    public void AGuardRepeatingTheRowsConstraintCollapses() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.String().NonEmpty()");
    ...
    public void AGuardStrengtheningTheRowsConstraintSurvives() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.String().NotBlank().WithMinLength(8)");
        Check.That(parameter.Provenance.HasFlag(Provenance.GuardsNotCombined)).IsFalse();
    }
    ...
    [InlineData("string",
                ...
                """,
                "Dummy.String().NonEmpty().WithMaxLength(10)")]
    ...
    [InlineData("""
                ...
                """,
                "Dummy.Int32().LessThanOrEqualTo(50)")]
    [InlineData("""
                ...
                """,
                "Dummy.Int32().GreaterThanOrEqualTo(40)")]
    ...
    /// </summary>
    /// <remarks>
    ///     The library refuses such a chain at construction with <c>ConflictingDummyConstraintException</c>, and
    ...
    [InlineData("if (value.Length > 0) { throw new ArgumentException(nameof(value)); }", "Dummy.String().WithMaxLength(0)")]
    [InlineData("if (value.Length != 0) { throw new ArgumentException(nameof(value)); }", "Dummy.String().WithLength(0)")]
    [InlineData("if (value.Length < 8) { throw new ArgumentException(nameof(value)); }", "Dummy.String().WithMinLength(8)")]
    ...
    /// </summary>
    /// <remarks>
    ///     <c>.NonZero()</c> is not declared on the enum engine — <c>DummyEnum&lt;T&gt;</c> carries only
    ...
    public void AFoldedPairStillReportsTheGuard() {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.Int32().Between(0, 100)");
        Check.That(parameter.Provenance.HasFlag(Provenance.Guard)).IsTrue();
        Check.That(parameter.Provenance.HasFlag(Provenance.ConstraintUnavailable)).IsFalse();
    }
    ...
    public void AGuardOnANullableIsReadBeforeTheConversion() {
        ...
        Check.That(Subject.GuardedBy("int?", guard).Expression)
             .IsEqualTo("Dummy.Int32().Positive().AsNullable()");
    }
    ...
    [InlineData("string", "Guard.IsNotNullOrEmpty(value, nameof(value));", "Dummy.String().NonEmpty()")]
    [InlineData("int", "Guard.IsGreaterThan(value, 0, nameof(value));", "Dummy.Int32().GreaterThan(0)")]
    [InlineData("int", "Guard.IsGreaterThanOrEqualTo(value, 18, nameof(value));", "Dummy.Int32().GreaterThanOrEqualTo(18)")]
    [InlineData("int", "Guard.IsLessThan(value, 100, nameof(value));", "Dummy.Int32().LessThan(100)")]
    [InlineData("int", "Guard.IsLessThanOrEqualTo(value, 100, nameof(value));", "Dummy.Int32().LessThanOrEqualTo(100)")]
    [InlineData("int", "Guard.IsInRange(value, 0, 100, nameof(value));", "Dummy.Int32().GreaterThanOrEqualTo(0).LessThan(100)")]
    ...
    [InlineData("string", "Guard.Against.NullOrEmpty(value);", "Dummy.String().NonEmpty()")]
    [InlineData("int", "Guard.Against.Negative(value);", "Dummy.Int32().GreaterThanOrEqualTo(0)")]
    [InlineData("int", "Guard.Against.NegativeOrZero(value);", "Dummy.Int32().Positive()")]
    [InlineData("int", "Guard.Against.Zero(value);", "Dummy.Int32().NonZero()")]
    [InlineData("int", "Guard.Against.OutOfRange(value, nameof(value), 0, 100);", "Dummy.Int32().Between(0, 100)")]
    [InlineData("string", "Guard.Against.StringTooShort(value, 3);", "Dummy.String().WithMinLength(3)")]
    [InlineData("string", "Guard.Against.StringTooLong(value, 20);", "Dummy.String().NonEmpty().WithMaxLength(20)")]
    [InlineData("string", "Guard.Against.LengthOutOfRange(value, 8, 20);", "Dummy.String().WithLengthBetween(8, 20)")]
    [InlineData("System.Guid", "Guard.Against.Default(value);", "Dummy.Guid().NonEmpty()")]
    [InlineData("int", "Guard.Against.Default(value);", "Dummy.Int32().NonZero()")]
    ...
    public void AGuardLibraryWhitespaceRejectionReadsAsNotBlank(string guard, string usings) {
        ...
        Check.That(parameter.Expression).IsEqualTo("Dummy.String().NotBlank()");
        Check.That(parameter.Provenance.HasFlag(Provenance.Guard)).IsTrue();
        Check.That(parameter.Provenance.HasFlag(Provenance.UnreadGuards)).IsFalse();
        Check.That(parameter.RequiresVerification).IsFalse();
    }
    ...
    public void AGuardAssignedToStateIsReadAndTheScanContinues() {
        ...
        Check.That(name.Expression).IsEqualTo("Dummy.String().NonEmpty()");
        Check.That(name.Provenance.HasFlag(Provenance.Guard)).IsTrue();
        Check.That(quantity.Expression).IsEqualTo("Dummy.Int32().Positive()");
    ...
    public void AnUnrecognisedAssignmentStillEndsTheScan() {
        ...
        Check.That(quantity.Expression).IsEqualTo("Dummy.Int32()");
