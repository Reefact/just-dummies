...
internal static class SweepAxes {
    ...
    ///     domain the sweep wrote, not an assumption about how <c>Dummy</c> draws. Everything else —
    ...
    internal sealed class Element(string name, string type, int cardinality) {
        ...
        /// </summary>
        /// <remarks>
        ///     True of the domain's classes and of nothing else: an enum is drawn by <c>Dummy.Enum&lt;T&gt;()</c>
