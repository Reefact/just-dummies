...
///     <c>Dummy.Int32().Positive().AsNullable()</c>, not the reverse, and a factory parameter guarded inside the
///     factory's body emits <c>Dummy.String().NonEmpty().As(OrderReference.Create)</c>. The conversion hop always
...
internal sealed class DrawnGenerator {
    ...
    /// <summary>The expression before any constraint — <c>Dummy.Int32()</c>.</summary>
