...
///         resolve is never emitted. A project on the <c>netstandard2.0</c> asset has no <c>Dummy.DateOnly()</c>,
...
internal sealed class LibrarySurface {
    ...
    internal INamedTypeSymbol Dummy { get; }

    /// <summary>The recipe interface the emitted generator implements.</summary>
    internal INamedTypeSymbol DummyOfT { get; }
    ...
    internal static LibrarySurface? In(Compilation compilation) {
        INamedTypeSymbol? any        = compilation.GetTypeByMetadataName("JustDummies.Dummy");
        INamedTypeSymbol? anyOfT     = compilation.GetTypeByMetadataName("JustDummies.IDummy`1");
        INamedTypeSymbol? extensions = compilation.GetTypeByMetadataName("JustDummies.DummyExtensions");
    ...
    /// <summary>
    ///     The builder type <c>Dummy.<paramref name="factory" />(…)</c> returns, or null when this compilation has
    ///     no such factory.
    /// </summary>
    ...
    internal ITypeSymbol? Returned(string factory, int typeArguments = 0, int parameters = 0) {
        ...
        IMethodSymbol? method = Dummy.GetMembers(factory)
    ...
    /// <summary>Whether the candidate is <c>AsNullable&lt;T&gt;(this IDummy&lt;T&gt;) -&gt; IDummy&lt;T?&gt;</c>.</summary>
    ...
    ///     <c>As&lt;TSource, TResult&gt;(this IDummy&lt;TSource&gt;, Func&lt;TSource, TResult&gt;) -&gt; IDummy&lt;TResult&gt;</c>.
    /// </summary>
    ...
    ///     <c>expr.As(…)</c>, not <c>DummyExtensions.As(expr, …)</c>, so a static method of the right name and
    ...
    /// <summary>Whether <paramref name="type" /> is <c>IDummy&lt;<paramref name="argument" />&gt;</c>.</summary>
    private bool Draws(ITypeSymbol type, ITypeSymbol argument) {
        return type is INamedTypeSymbol named
            && SymbolEqualityComparer.Default.Equals(named.OriginalDefinition, DummyOfT)
