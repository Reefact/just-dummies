...
public sealed class AnyInt128 : IAny<Int128>, IHasRandomSource, ICardinalityHint<Int128>, IPoolInspection<Int128> {
    ...
    public AnyInt128 Positive() {
        return new AnyInt128(_source, _spec.WithMinimum(Ord(1), ConstraintCall.Of(nameof(Positive))));
    }
    ...
    public AnyInt128 Negative() {
        return new AnyInt128(_source, _spec.WithMaximum(Ord(-1), ConstraintCall.Of(nameof(Negative))));
    }
    ...
    public AnyInt128 Zero() {
        return new AnyInt128(_source, _spec.WithMinimum(Ord(0), ConstraintCall.Of(nameof(Zero))).WithMaximum(Ord(0), ConstraintCall.Of(nameof(Zero))));
    }
    ...
    public AnyInt128 NonZero() {
        return new AnyInt128(_source, _spec.WithExcluded([Ord(0)], ConstraintCall.Of(nameof(NonZero))));
    }
    ...
    public AnyInt128 GreaterThan(Int128 value) {
        return new AnyInt128(_source, _spec.WithMinimumAbove(Ord(value), ConstraintCall.Of(nameof(GreaterThan), V(value))));
    }
    ...
    public AnyInt128 GreaterThanOrEqualTo(Int128 value) {
        return new AnyInt128(_source, _spec.WithMinimum(Ord(value), ConstraintCall.Of(nameof(GreaterThanOrEqualTo), V(value))));
    }
    ...
    public AnyInt128 LessThan(Int128 value) {
        return new AnyInt128(_source, _spec.WithMaximumBelow(Ord(value), ConstraintCall.Of(nameof(LessThan), V(value))));
    }
    ...
    public AnyInt128 LessThanOrEqualTo(Int128 value) {
        return new AnyInt128(_source, _spec.WithMaximum(Ord(value), ConstraintCall.Of(nameof(LessThanOrEqualTo), V(value))));
    }
    ...
    /// <exception cref="ConflictingAnyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public AnyInt128 MultipleOf(Int128 value) {
        if (value <= 0) { throw new ArgumentOutOfRangeException(nameof(value), value, "The multiple must be strictly positive."); }

        return new AnyInt128(_source, _spec.WithStep((UInt128)value, Ord(0), ConstraintCall.Of(nameof(MultipleOf), V(value))));
    }
    ...
    public AnyInt128 OneOf(params Int128[] values) {
        ...
        return new AnyInt128(_source, _spec.WithAllowed(values.Select(Ord).ToArray(), ConstraintCall.Of(nameof(OneOf), Join(values))));
    }

    /// <summary>
    ///     Requires the value to be one of the supplied values — the <see cref="IEnumerable{T}" /> counterpart of
    ///     <see cref="OneOf(Int128[])" />, for a set already held as a sequence (a list, a LINQ result, values loaded at
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty.</exception>
    /// <exception cref="ConflictingAnyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public AnyInt128 OneOf(IEnumerable<Int128> values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }

        return OneOf(values as Int128[] ?? values.ToArray());
    }
    ...
    public AnyInt128 Except(params Int128[] values) {
        ...
        return new AnyInt128(_source, _spec.WithExcluded(values.Select(Ord).ToArray(), ConstraintCall.Of(nameof(Except), Join(values))));
    }
    ...
    public AnyInt128 DifferentFrom(Int128 value) {
        return new AnyInt128(_source, _spec.WithExcluded([Ord(value)], ConstraintCall.Of(nameof(DifferentFrom), V(value))));
    }
