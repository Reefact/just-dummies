...
/// </summary>
public sealed class AnyUInt64 : IAny<ulong>, IHasRandomSource, ICardinalityHint<ulong> {
    ...
    public AnyUInt64 MultipleOf(ulong value) {
        ...
        return new AnyUInt64(_source, _spec.WithStep(value, Ord(0), $"MultipleOf({V(value)})"));
    }
