...
///     <c>Dummy.String().WithLength(3).StartingWith("ORD-")</c>, where the prefix alone already requires 4
...
/// </summary>
public sealed class ConflictingDummyConstraintException : DummyException {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException NoValueSatisfies(ConstraintCall applying, string typeName) {
    ...
    ///     nothing by itself.
    /// </summary>
    internal static ConflictingDummyConstraintException NoValueRemains(ConstraintCall applying, string exhaustion) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException AlreadyDefined(ConstraintCall applying, ConstraintCall existingConstraint) {
    ...
    /// </remarks>
    internal static ConflictingDummyConstraintException Contradicts(ConstraintCall applying, ConstraintClaim culprit, ConstraintClaim otherwise) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException NoPooledValueSurvives(ConstraintCall applying, string exhaustion) {
        return Sentence(applying, exhaustion);
    }
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException AlreadyPinned(ConstraintCall applying, ConstraintCall pinningConstraint, string value) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException PinnedValueExcluded(ConstraintCall applying, ConstraintCall pinningConstraint, string value, string forbidding) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException PinnedValueNotAllowed(ConstraintCall applying, ConstraintCall pinningConstraint, string value, ConstraintCall allowingConstraint) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException EnumIsNotFlags(ConstraintCall applying, string enumName) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException TooManyCombinableMembers(ConstraintCall applying, string enumName, string declared, string maximum) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException ContainedElementsDoNotFit(ConstraintCall applying, string required, string capacity) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException ComparerAlreadyDefined(ConstraintCall applying) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException DuplicateInDistinctCollection(ConstraintCall applying, string value) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException DistinctElementsExceedCardinality(ConstraintCall applying, string required, string cardinality) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException AlreadyBoundedAbove(ConstraintCall applying, ConstraintCall existingConstraint, string bound) {
    ...
    /// </summary>
    internal static ConflictingDummyConstraintException AlreadyBoundedBelow(ConstraintCall applying, ConstraintCall existingConstraint, string bound) {
    ...
    private static ConflictingDummyConstraintException Sentence(ConstraintCall applying, string reason) {
        return new ConflictingDummyConstraintException($"Cannot apply {applying} because {reason}.");
    }

    #endregion

    /// <summary>
    ///     Initializes a new instance of the <see cref="ConflictingDummyConstraintException" /> class.
    /// </summary>
    ...
    public ConflictingDummyConstraintException(string message) : base(message) { }
