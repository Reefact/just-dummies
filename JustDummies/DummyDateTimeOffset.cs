...
/// </remarks>
public sealed class DummyDateTimeOffset : IDummy<DateTimeOffset>, IHasRandomSource, IComparerSensitiveCardinality<DateTimeOffset>, IPoolInspection<DateTimeOffset> {
    ...
    internal static DummyDateTimeOffset Create(RandomSource source) {
        if (source is null) { throw new ArgumentNullException(nameof(source)); }

        return new DummyDateTimeOffset(source, OrdinalIntervalSpec.Unconstrained("DateTimeOffset", ordinal => V(Val(ordinal)), Ord(DateTimeOffset.MinValue), Ord(DateTimeOffset.MaxValue)), null, null, 0, 0);
    }
    ...
    private DummyDateTimeOffset(RandomSource source, OrdinalIntervalSpec spec, IReadOnlyDictionary<ulong, DateTimeOffset[]>? allowedOriginals,
    ...
    public DummyDateTimeOffset After(DateTimeOffset instant) {
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset AfterOrEqualTo(DateTimeOffset instant) {
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset Before(DateTimeOffset instant) {
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset BeforeOrEqualTo(DateTimeOffset instant) {
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset Between(DateTimeOffset start, DateTimeOffset end) {
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset WithGranularity(TimeSpan granularity) {
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset WithOffset(TimeSpan offset) {
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset WithOffsetBetween(TimeSpan minimum, TimeSpan maximum) {
    ...
    public DummyDateTimeOffset OneOf(params DateTimeOffset[] values) {
        ...
        return new DummyDateTimeOffset(_source, NarrowedToTheDeclaredOffset(allowed, supplied, applying, _offsetMinMinutes, _offsetMaxMinutes, _offsetConstraint),
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset Except(params DateTimeOffset[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyDateTimeOffset DifferentFrom(DateTimeOffset value) {
    ...
    private DummyDateTimeOffset With(OrdinalIntervalSpec spec) {
        return new DummyDateTimeOffset(_source, spec, _allowedOriginals, _offsetConstraint, _offsetMinMinutes, _offsetMaxMinutes);
    }
    ...
    private DummyDateTimeOffset WithOffsetRange(int minMinutes, int maxMinutes, ConstraintCall applying) {
        if (_offsetConstraint is not null) {
            if (_offsetMinMinutes == minMinutes && _offsetMaxMinutes == maxMinutes) { return this; }

            throw ConflictingDummyConstraintException.AlreadyDefined(applying, _offsetConstraint);
        }
        ...
        if (_allowedOriginals is not null) {
            return new DummyDateTimeOffset(_source, NarrowedToTheDeclaredOffset(spec, _allowedOriginals, applying, minMinutes, maxMinutes, applying),
                                         _allowedOriginals, applying, minMinutes, maxMinutes);
        }

        return new DummyDateTimeOffset(_source, spec, _allowedOriginals, applying, minMinutes, maxMinutes);
    }
    ...
    private static ConflictingDummyConstraintException OffsetExcludesEveryPooledValue(ConstraintCall applying, int minMinutes, int maxMinutes) {
        ...
        return new ConflictingDummyConstraintException($"Cannot apply {applying} because no pooled value carries an offset it admits ({admitted}).");
    }
