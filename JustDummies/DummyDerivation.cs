...
internal static class DummyDerivation {
    ...
    /// </summary>
    internal static bool IsReproducible<T>(IDummy<T> generator) {
        if (generator is null) { throw new ArgumentNullException(nameof(generator)); }
    ...
    ///     individually reproducible but draws from a <i>different</i> seeded source (a second <see cref="Dummy.WithSeed" />
    ...
    /// </summary>
    internal static bool DrawsOnlyFrom<T>(IDummy<T> generator, RandomSource? source) {
    ...
    /// </summary>
    internal static long? CardinalityOf<T>(IDummy<T> generator) {
        if (generator is null) { throw new ArgumentNullException(nameof(generator)); }
    ...
    /// </remarks>
    internal static long? CardinalityOf<T>(IDummy<T> generator, IEqualityComparer<T>? comparer) {
        if (generator is null) { throw new ArgumentNullException(nameof(generator)); }
    ...
    ///     <see cref="DummyGenerationException" /> that names the generated value(s) and, when the random context is
    ...
    internal static T Invoke<T>(Func<T> invoke, RandomSource? source, bool reproducible, Func<string> failure) {
        ...
        try {
            ...
            throw DummyGenerationException.FactoryFailed(failure, exception, source, reproducible);
        }
    }
