...
/// <summary>
///     A fluent generator of arbitrary <see cref="long" /> values — the same contract as <see cref="DummyInt32" />:
...
/// </summary>
public sealed class DummyInt64 : IDummy<long>, IHasRandomSource, ICardinalityHint<long>, IPoolInspection<long> {

    #region Statics members declarations

    internal static DummyInt64 Create(RandomSource source) {
        if (source is null) { throw new ArgumentNullException(nameof(source)); }

        return new DummyInt64(source, OrdinalIntervalSpec.Unconstrained("Int64", ordinal => V(Val(ordinal)), Ord(long.MinValue), Ord(long.MaxValue)));
    }

    private static ulong Ord(long value) {
        return OrdinalMapping.FromInt64(value);
    }

    private static long Val(ulong ordinal) {
    ...
    private DummyInt64(RandomSource source, OrdinalIntervalSpec spec) {
        _source = source;
        _spec   = spec;
    }
    ...
    long? ICardinalityHint<long>.DistinctCardinality => _spec.Cardinality;

    bool ICardinalityHint<long>.Contains(long value) => _spec.Contains(Ord(value));
    ...
    bool IPoolInspection<long>.IsPooled => _spec.IsPooled;

    IReadOnlyList<long> IPoolInspection<long>.GetSurvivors() => _spec.GetSurvivors(Val);

    IReadOnlyList<PoolRejection<long>> IPoolInspection<long>.GetRejections() => _spec.GetRejections(Val);
    ...
    public DummyInt64 Positive() {
        return new DummyInt64(_source, _spec.WithMinimum(Ord(1), ConstraintCall.Of(nameof(Positive))));
    }

    /// <summary>Requires a value strictly less than zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 Negative() {
        return new DummyInt64(_source, _spec.WithMaximum(Ord(-1), ConstraintCall.Of(nameof(Negative))));
    }

    /// <summary>Pins the value to exactly zero. Useful for symmetry with the other constraints when a test sweeps cases.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 Zero() {
        return new DummyInt64(_source, _spec.WithMinimum(Ord(0), ConstraintCall.Of(nameof(Zero))).WithMaximum(Ord(0), ConstraintCall.Of(nameof(Zero))));
    }

    /// <summary>Requires a value different from zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 NonZero() {
        return new DummyInt64(_source, _spec.WithExcluded([Ord(0)], ConstraintCall.Of(nameof(NonZero))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 GreaterThan(long value) {
        return new DummyInt64(_source, _spec.WithMinimumAbove(Ord(value), ConstraintCall.Of(nameof(GreaterThan), V(value))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 GreaterThanOrEqualTo(long value) {
        return new DummyInt64(_source, _spec.WithMinimum(Ord(value), ConstraintCall.Of(nameof(GreaterThanOrEqualTo), V(value))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 LessThan(long value) {
        return new DummyInt64(_source, _spec.WithMaximumBelow(Ord(value), ConstraintCall.Of(nameof(LessThan), V(value))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 LessThanOrEqualTo(long value) {
        return new DummyInt64(_source, _spec.WithMaximum(Ord(value), ConstraintCall.Of(nameof(LessThanOrEqualTo), V(value))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 Between(long minimum, long maximum) {
        ...
        return new DummyInt64(_source, _spec.WithMinimum(Ord(minimum), constraint).WithMaximum(Ord(maximum), constraint));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 MultipleOf(long value) {
        if (value <= 0) { throw new ArgumentOutOfRangeException(nameof(value), value, "The multiple must be strictly positive."); }

        return new DummyInt64(_source, _spec.WithStep((ulong)value, Ord(0), ConstraintCall.Of(nameof(MultipleOf), V(value))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 OneOf(params long[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }

        return new DummyInt64(_source, _spec.WithAllowed(values.Select(Ord).ToArray(), ConstraintCall.Of(nameof(OneOf), Join(values))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 Except(params long[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }

        return new DummyInt64(_source, _spec.WithExcluded(values.Select(Ord).ToArray(), ConstraintCall.Of(nameof(Except), Join(values))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyInt64 DifferentFrom(long value) {
        return new DummyInt64(_source, _spec.WithExcluded([Ord(value)], ConstraintCall.Of(nameof(DifferentFrom), V(value))));
    }
