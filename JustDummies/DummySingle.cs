...
/// <summary>
///     A fluent generator of arbitrary <see cref="float" /> values — the same contract as <see cref="DummyInt32" />:
...
///         <c>Dummy.OneOf(float.NaN, 1.0f, 2.0f)</c>. The generic entry points carry no finiteness rule, by construction.
...
///     </para>
/// </remarks>
public sealed class DummySingle : IDummy<float>, IHasRandomSource, ICardinalityHint<float>, IPoolInspection<float> {

    #region Statics members declarations

    internal static DummySingle Create(RandomSource source) {
        if (source is null) { throw new ArgumentNullException(nameof(source)); }

        return new DummySingle(source, ContinuousIntervalSpec.Unconstrained("Single", value => V((float)value), value => (float)value, value => NextUp((float)value), -float.MaxValue, float.MaxValue));
    }
    ...
    private DummySingle(RandomSource source, ContinuousIntervalSpec spec) {
        _source = source;
        _spec   = spec;
    }
    ...
    public DummySingle Positive() {
        return new DummySingle(_source, _spec.WithMinimumAbove(0d, ConstraintCall.Of(nameof(Positive))));
    }

    /// <summary>Requires a value strictly less than zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle Negative() {
        return new DummySingle(_source, _spec.WithMaximumBelow(0d, ConstraintCall.Of(nameof(Negative))));
    }

    /// <summary>Pins the value to exactly zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle Zero() {
        return new DummySingle(_source, _spec.WithMinimum(0d, ConstraintCall.Of(nameof(Zero))).WithMaximum(0d, ConstraintCall.Of(nameof(Zero))));
    }

    /// <summary>Requires a value different from zero.</summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle NonZero() {
        return new DummySingle(_source, _spec.WithExcluded([0d], ConstraintCall.Of(nameof(NonZero))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle GreaterThan(float value) {
        ContinuousIntervalSpec.EnsureFinite(value, nameof(value));
        return new DummySingle(_source, _spec.WithMinimumAbove(value, ConstraintCall.Of(nameof(GreaterThan), V(value))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="value" /> is not finite.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle GreaterThanOrEqualTo(float value) {
        ContinuousIntervalSpec.EnsureFinite(value, nameof(value));
        return new DummySingle(_source, _spec.WithMinimum((double)value, ConstraintCall.Of(nameof(GreaterThanOrEqualTo), V(value))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="value" /> is not finite.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle LessThan(float value) {
        ContinuousIntervalSpec.EnsureFinite(value, nameof(value));
        return new DummySingle(_source, _spec.WithMaximumBelow(value, ConstraintCall.Of(nameof(LessThan), V(value))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="value" /> is not finite.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle LessThanOrEqualTo(float value) {
        ContinuousIntervalSpec.EnsureFinite(value, nameof(value));
        return new DummySingle(_source, _spec.WithMaximum((double)value, ConstraintCall.Of(nameof(LessThanOrEqualTo), V(value))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle Between(float minimum, float maximum) {
        ...
        return new DummySingle(_source, _spec.WithMinimum((double)minimum, constraint).WithMaximum((double)maximum, constraint));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle OneOf(params float[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }
        foreach (float value in values) { ContinuousIntervalSpec.EnsureFinite(value, nameof(values)); }

        return new DummySingle(_source, _spec.WithAllowed(values.Select(value => (double)value).ToArray(), ConstraintCall.Of(nameof(OneOf), Join(values))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty or contains a non-finite value.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle Except(params float[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }
        foreach (float value in values) { ContinuousIntervalSpec.EnsureFinite(value, nameof(values)); }

        return new DummySingle(_source, _spec.WithExcluded(values.Select(value => (double)value).ToArray(), ConstraintCall.Of(nameof(Except), Join(values))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="value" /> is not finite.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummySingle DifferentFrom(float value) {
        ContinuousIntervalSpec.EnsureFinite(value, nameof(value));
        return new DummySingle(_source, _spec.WithExcluded([(double)value], ConstraintCall.Of(nameof(DifferentFrom), V(value))));
    }
