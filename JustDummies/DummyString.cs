...
///     each other fail immediately with a <see cref="ConflictingDummyConstraintException" /> naming both sides, so an
...
///     <example>
///         <code>
///         string code = Dummy.String().NonEmpty().WithMaxLength(50).StartingWith("ORD-").Generate();
///         string reference = Dummy.String().StartingWith("ORD-").AlphaNumeric().InUpperCase().WithLength(12).Generate();
///         Dummy.String().WithLength(3).StartingWith("ORD-");  // throws ConflictingDummyConstraintException
///         </code>
///     </example>
/// </remarks>
public sealed class DummyString : IDummy<string>, IHasRandomSource, ICardinalityHint<string>, IPoolInspection<string> {
    ...
    internal DummyString(RandomSource source, StringSpec spec) {
    ...
    public DummyString NonEmpty() {
        return new DummyString(_source, _spec.WithMinLength(1, ConstraintCall.Of(nameof(NonEmpty))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString NotBlank() {
        return new DummyString(_source, _spec.WithNotBlank(ConstraintCall.Of(nameof(NotBlank))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString WithLength(int length) {
        RequireProducible(length, nameof(length));

        return new DummyString(_source, _spec.WithExactLength(length, ConstraintCall.Of(nameof(WithLength), V(length))));
    }
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="length" /> is negative or exceeds 1000000, the largest length a generator is asked to produce.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString WithMinLength(int length) {
        RequireProducible(length, nameof(length));

        return new DummyString(_source, _spec.WithMinLength(length, ConstraintCall.Of(nameof(WithMinLength), V(length))));
    }
    ...
    /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="length" /> is negative or exceeds 1000000, the largest length a generator is asked to produce.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString WithMaxLength(int length) {
        RequireProducible(length, nameof(length));

        return new DummyString(_source, _spec.WithMaxLength(length, ConstraintCall.Of(nameof(WithMaxLength), V(length))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString WithLengthBetween(int minimum, int maximum) {
        ...
        return new DummyString(_source, _spec.WithMinLength(minimum, constraint).WithMaxLength(maximum, constraint));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString StartingWith(string prefix) {
        RequireText(prefix, nameof(prefix));

        return new DummyString(_source, _spec.WithPrefix(prefix, ConstraintCall.Of(nameof(StartingWith), Q(prefix))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString EndingWith(string suffix) {
        RequireText(suffix, nameof(suffix));

        return new DummyString(_source, _spec.WithSuffix(suffix, ConstraintCall.Of(nameof(EndingWith), Q(suffix))));
    }
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Containing(string value) {
        RequireText(value, nameof(value));

        return new DummyString(_source, _spec.WithFragment(value, ConstraintCall.Of(nameof(Containing), Q(value))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Alpha() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Alpha, ConstraintCall.Of(nameof(Alpha))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Numeric() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Numeric, ConstraintCall.Of(nameof(Numeric))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString AlphaNumeric() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.AlphaNumeric, ConstraintCall.Of(nameof(AlphaNumeric))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Punctuation() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Punctuation, ConstraintCall.Of(nameof(Punctuation))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Printable() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Printable, ConstraintCall.Of(nameof(Printable))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString NonPrintable() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.NonPrintable, ConstraintCall.Of(nameof(NonPrintable))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Whitespaces() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Whitespaces, ConstraintCall.Of(nameof(Whitespaces))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString Hexadecimal() {
        return new DummyString(_source, _spec.WithCharset(CharacterSet.Hexadecimal, ConstraintCall.Of(nameof(Hexadecimal))));
    }
    ...
    /// </summary>
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the subtraction leaves no character drawable.</exception>
    public DummyString WithoutAlpha() {
        return new DummyString(_source, _spec.WithSubtraction(CharacterSet.Alpha, ConstraintCall.Of(nameof(WithoutAlpha))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the subtraction leaves no character drawable.</exception>
    public DummyString WithoutNumeric() {
        return new DummyString(_source, _spec.WithSubtraction(CharacterSet.Numeric, ConstraintCall.Of(nameof(WithoutNumeric))));
    }
    ...
    ///     <see cref="Dummy.StringMatching(string)" /> literal. Declared once per generator: it occupies the same
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString WithChars(string pool) {
        ...
        return new DummyString(_source, _spec.WithCharPool(distinct, ConstraintCall.Of(nameof(WithChars), Q(pool))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString InLowerCase() {
        return new DummyString(_source, _spec.WithCasing(LetterCasing.Lower, ConstraintCall.Of(nameof(InLowerCase))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString InUpperCase() {
        return new DummyString(_source, _spec.WithCasing(LetterCasing.Upper, ConstraintCall.Of(nameof(InUpperCase))));
    }
    ...
    ///     <see cref="DummyGenerationException" /> rather than as a declaration-time conflict. On a string drawn from a
    ...
    /// <exception cref="ConflictingDummyConstraintException">Thrown when a value set is in force and the exclusion leaves none of its values.</exception>
    public DummyString Except(params string[] values) {
        ...
        return new DummyString(_source, _spec.WithExcluded(values, ConstraintCall.Of(nameof(Except), Join(values))));
    }
    ...
    /// <returns>A new generator carrying the added constraint.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value" /> is <c>null</c>.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when a value set is in force and <paramref name="value" /> is the only value it leaves.</exception>
    public DummyString DifferentFrom(string value) {
        if (value is null) { throw new ArgumentNullException(nameof(value)); }

        return new DummyString(_source, _spec.WithExcluded([value], ConstraintCall.Of(nameof(DifferentFrom), Q(value))));
    }
    ...
    ///     <see cref="ConflictingDummyConstraintException" /> naming both sides, whichever order the two were declared
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty or contains a <c>null</c> element.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString OneOf(params string[] values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
        if (values.Length == 0) { throw new ArgumentException("At least one value is required.", nameof(values)); }
        ...
        return new DummyString(_source, _spec.WithAllowed(values, ConstraintCall.Of(nameof(OneOf), Join(values))));
    }
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="values" /> is empty or contains a <c>null</c> element.</exception>
    /// <exception cref="ConflictingDummyConstraintException">Thrown when the constraint contradicts a constraint already declared.</exception>
    public DummyString OneOf(IEnumerable<string> values) {
        if (values is null) { throw new ArgumentNullException(nameof(values)); }
