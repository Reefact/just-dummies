...
Aucune dépendance à l'exécution, et les 31 règles d'analyzer sont embarquées — elles se mettent à travailler dès
...
| Paquet | Ce que c'est |
| --- | --- |
| [`JustDummies`](doc/handwritten/for-users/packages/justdummies.fr.md) | la bibliothèque, avec ses 31 règles embarquées |
| [`JustDummies.Xunit`](doc/handwritten/for-users/packages/justdummies-xunit.fr.md) | l'adaptateur xUnit v3 : `[Reproducible]` |
| [`JustDummies.DiagnosticCatalog`](doc/handwritten/for-users/packages/justdummies-diagnosticcatalog.fr.md) | les règles `JD001`–`JD031` en constantes vérifiées par le compilateur |
