...
No runtime dependency, and the 29 analyzer rules come bundled inside — they start working on your next
build.
...
| Package | What it is |
| --- | --- |
| [`JustDummies`](doc/handwritten/for-users/packages/justdummies.en.md) | the library, with its 29 rules bundled in |
| [`JustDummies.Xunit`](doc/handwritten/for-users/packages/justdummies-xunit.en.md) | the xUnit v3 adapter: `[Reproducible]` |
| [`JustDummies.DiagnosticCatalog`](doc/handwritten/for-users/packages/justdummies-diagnosticcatalog.en.md) | the `JD001`–`JD029` rules as compile-checked constants |
