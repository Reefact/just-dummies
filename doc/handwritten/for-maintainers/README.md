...
| [The `dum` scaffolder](./specifications/justdummies-tool.md) | specified and implemented; `dum generate` runs, and the `cli` train has published it up to `cli-v1.1.0-beta.1` |
