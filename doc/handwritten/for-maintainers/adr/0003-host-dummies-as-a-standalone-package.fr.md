# ADR-0003 | Héberger JustDummies comme package autonome dans ce dépôt

🌍 🇬🇧 [English](0003-host-dummies-as-a-standalone-package.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-19
**Accepté :** 2026-07-19
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0014.**
...
* [ADR-0006 (first-class-errors)](https://github.com/Reefact/first-class-errors/blob/main/doc/handwritten/for-maintainers/adr/0006-supply-arbitrary-test-values-from-a-seedable-source.fr.md)
