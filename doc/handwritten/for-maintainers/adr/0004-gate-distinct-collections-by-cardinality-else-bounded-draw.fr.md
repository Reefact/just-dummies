# ADR-0004 | Contrôler les collections distinctes par la cardinalité, sinon par un tirage borné

🌍 🇬🇧 [English](0004-gate-distinct-collections-by-cardinality-else-bounded-draw.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-19
**Accepté :** 2026-07-19
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0016.**
...
* [ADR-0003](0003-host-dummies-as-a-standalone-package.fr.md)
