# ADR-0006 | Matérialiser les dummies uniquement via Generate()

🌍 🇬🇧 [English](0006-materialize-dummies-only-through-generate.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-19
**Accepté :** 2026-07-19
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0024.**
...
référencé que par son propre projet de test (ADR-0003) ; retirer une surface
...
* **C'est le moment le moins coûteux pour décider.** Le package est pré-1.0,
  autonome et auto-consommé (ADR-0003), donc le changement ne touche aujourd'hui
