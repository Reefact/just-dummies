# ADR-0007 | Fixer le plancher .NET Framework de la bibliothèque à 4.7.2

🌍 🇬🇧 [English](0007-floor-the-library-on-net-framework-4-7-2.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-19
**Accepté :** 2026-07-19
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0027.**
...
* [ADR-0002 (first-class-errors)](https://github.com/Reefact/first-class-errors/blob/main/doc/handwritten/for-maintainers/adr/0002-floor-the-tooling-runtime.fr.md) — raffiné par cet ADR pour le plancher .NET Framework de la bibliothèque.
* [ADR-0001](https://github.com/Reefact/first-class-errors/blob/main/doc/handwritten/for-maintainers/adr/0001-lock-the-analyzer-roslyn-floor.fr.md)
