# ADR-0008 | Générer les chaînes qui matchent depuis un sous-ensemble régulier maison

🌍 🇬🇧 [English](0008-generate-strings-from-a-home-grown-regular-subset.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-26
**Accepté :** 2026-07-26
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0030.**
...
* La bibliothèque est livrée **sans aucune dépendance runtime** et en fait un élément de son identité ; la
  frontière est vérifiée par un test d'architecture (ADR-0003). Ajouter une référence de paquet est donc un choix
...
* ADR-0003 — Héberger JustDummies comme un paquet autonome dans ce dépôt (la frontière zéro-dépendance).
