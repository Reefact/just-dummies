# ADR-0009 | Tirer des chaînes arbitraires depuis un ensemble de valeurs explicite et terminal

🌍 🇬🇧 [English](0009-draw-arbitrary-strings-from-an-explicit-terminal-set.md) · 🇫🇷 Français (ce fichier)

**Statut :** Superseded par l'[ADR-0033](0033-decide-a-constraint-surface-by-constructive-versus-rejective.fr.md)
**Proposé :** 2026-07-21
**Accepté :** 2026-07-21
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0038.**
...
* ADR-0008 — Générer les chaînes qui matchent depuis un sous-ensemble régulier maison (le précédent du générateur
  terminal).
