# ADR-0009 | Draw arbitrary strings from an explicit, terminal value set

🌍 🇬🇧 English (this file) · 🇫🇷 [Français](0009-draw-arbitrary-strings-from-an-explicit-terminal-set.fr.md)

**Status:** Superseded by [ADR-0033](0033-decide-a-constraint-surface-by-constructive-versus-rejective.md)
**Proposed:** 2026-07-21
**Accepted:** 2026-07-21
