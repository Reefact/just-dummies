...
* L'ADR-0009 a ajouté `Any.String().OneOf(...)` comme générateur d'ensemble de valeurs **terminal** chaîné sur le point
...
Rejetée parce qu'elle contredirait le `Any.String().OneOf(...)` livré (ADR-0009), réintroduirait l'ambiguïté
