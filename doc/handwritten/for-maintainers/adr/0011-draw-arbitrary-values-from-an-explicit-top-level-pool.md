...
* ADR-0009 added `Any.String().OneOf(...)` as a **terminal** value-set generator chained off the string entry point:
...
Rejected because it would contradict the shipped `Any.String().OneOf(...)` (ADR-0009), reintroduce the
