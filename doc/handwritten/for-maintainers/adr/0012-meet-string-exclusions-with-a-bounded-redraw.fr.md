# ADR-0012 | Traiter les exclusions de chaînes par un tirage borné

🌍 🇬🇧 [English](0012-meet-string-exclusions-with-a-bounded-redraw.md) · 🇫🇷 Français (ce fichier)
...
* Une exclusion insatisfaisable échoue de manière sûre, reproductible, et nomme la seed à rejouer — cohérent avec l'ADR-0004.
...
* Un budget mal calibré pourrait faire échouer une forme théoriquement satisfaisable mais extrêmement serrée. Mesure : documenter le budget et le réviser sur la base de faits, plutôt que de présenter l'échec comme impossible (la posture de l'ADR-0004).
