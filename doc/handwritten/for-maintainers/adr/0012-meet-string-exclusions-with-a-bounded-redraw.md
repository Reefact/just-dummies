# ADR-0012 | Meet string exclusions with a bounded redraw

🌍 🇬🇧 English (this file) · 🇫🇷 [Français](0012-meet-string-exclusions-with-a-bounded-redraw.fr.md)
...
* An unsatisfiable exclusion fails safely, reproducibly, and names the seed to replay — consistent with ADR-0004.
...
* A poorly tuned budget could fail a theoretically satisfiable but extremely tight shape. Mitigation: keep the budget documented and revise it on evidence, rather than describing failure as impossible (the posture of ADR-0004).
