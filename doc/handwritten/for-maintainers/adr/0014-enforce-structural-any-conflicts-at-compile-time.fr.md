# ADR-0014 | Détecter les conflits structurels de Any à la compilation, ceux dépendant de la valeur à l'exécution

🌍 🇬🇧 [English](0014-enforce-structural-any-conflicts-at-compile-time.md) · 🇫🇷 Français (ce fichier)
...
* Rendre les erreurs de catégorie impossibles à écrire les retire aussi de la surface qu'un lecteur doit
  ...
  vérifiée » que l'ADR-0010 a appliqué au nommage des fabriques.
