# ADR-0016 | Vary the DateTimeOffset offset dimension

🌍 🇬🇧 English (this file) · 🇫🇷 [Français](0016-vary-the-datetimeoffset-offset-dimension.fr.md)

**Status:** Superseded by [ADR-0030](0030-filter-the-datetimeoffset-pool-by-the-declared-offset.md)
**Proposed:** 2026-07-26
**Accepted:** 2026-07-26
**Decision Makers:** Reefact
**Originally recorded in `Reefact/first-class-errors` as ADR-0037.**
