# ADR-0017 | Ouvrir la portée de graine ambiante aux adaptateurs de framework de test

🌍 🇬🇧 [English](0017-open-the-ambient-seed-scope-to-adapters.md) · 🇫🇷 Français (ce fichier)
...
`JustDummies` est en pré-1.0 et n'est pas encore publié sur NuGet (ADR-0003), donc sa
