# ADR-0018 | Adapter JustDummies à xUnit v3 via un package compagnon

🌍 🇬🇧 [English](0018-adapt-dummies-to-xunit-v3-through-a-companion-package.md) · 🇫🇷 Français (ce fichier)

**Statut :** Accepté
**Proposé :** 2026-07-26
**Accepté :** 2026-07-26
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0039.**
...
standard (ADR-0003), une frontière qu'un test d'architecture vérifie sur son
...
L'ADR-0017 ouvre la portée de graine ambiante sous forme de poignée publique, si
...
* **L'étroitesse est délibérée et peu coûteuse à réexaminer.** Parce que
  l'ADR-0017 rend la portée de graine publiquement atteignable, un adaptateur
...
* Ne réexaminer un adaptateur pour un autre framework que sur demande démontrée ;
  l'ADR-0017 garde chacun additif.
