# ADR-0018 | Adapt JustDummies to xUnit v3 through a companion package

🌍 🇬🇧 English (this file) · 🇫🇷 [Français](0018-adapt-dummies-to-xunit-v3-through-a-companion-package.fr.md)

**Status:** Accepted
**Proposed:** 2026-07-26
**Accepted:** 2026-07-26
**Decision Makers:** Reefact
**Originally recorded in `Reefact/first-class-errors` as ADR-0039.**
...
(ADR-0003), a boundary an architecture test asserts over its own assembly. It
...
ADR-0017 opens the ambient seed scope as a public handle, so an adapter needs no
...
* **Narrowness is deliberate and cheap to revisit.** Because ADR-0017 makes the
...
* Revisit an adapter for another framework only on demonstrated demand; ADR-0017
