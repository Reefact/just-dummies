# ADR-0019 | Répartir le banc de test de JustDummies entre une suite par l'exemple et une suite par propriétés

🌍 🇬🇧 [English](0019-split-the-justdummies-test-bed-between-example-and-property-suites.md) · 🇫🇷 Français (ce fichier)
...
L'audit d'architecture de juillet 2026 a relevé que l'ADR-0008 cite « a property
...
* L'aller-retour sur les expressions régulières est prouvé par une véritable propriété,
  ce qui permet de reformuler exactement l'affirmation de l'ADR-0008 : le constat
...
* Une propriété dont les arguments générés chevauchent une frontière de légalité
  dépendante de la valeur (ADR-0014) peut être écrite de façon à échouer par
...
* Réexaminer la formulation « property test » de l'ADR-0008, que l'audit a signalée comme
...
* [ADR-0008](0008-generate-strings-from-a-home-grown-regular-subset.fr.md) — le sous-ensemble régulier dont cette suite prouve l'aller-retour
* [ADR-0014](0014-enforce-structural-any-conflicts-at-compile-time.fr.md) — conflits structurels contre conflits dépendants de la valeur, qui décident de la façon dont une propriété doit se ramifier
* [ADR-0015](0015-draw-lattice-constrained-scalars-on-the-grid.fr.md) — les contraintes de treillis, dont l'invariant de grille est quantifié par la suite par propriétés
* [Audit d'architecture et de conception de JustDummies, 2026-07-20](../audit/2026-07-20-dummies-architecture-and-design-audit.fr.md) — le constat « non property-based » sur l'ADR-0008
