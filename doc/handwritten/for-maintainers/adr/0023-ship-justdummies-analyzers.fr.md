...
**Accepté :** 2026-07-27
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0044.**
...
* Le choix de la contrainte suit ce que chaque mécanisme peut porter (le même grain qu'ADR-0014). Le système de types
...
* ADR-0014 — imposer les conflits Any structurels à la compilation, ceux dépendant de la valeur à l'exécution ; le
  grain « les types là où ils peuvent porter la règle, des vérifications là où ils ne peuvent pas » que suit cette
  décision.
* ADR-0010 — nommer les fabriques d'Any d'après leur type CLR ; précédent pour « rendre la règle in-cassable plutôt
  que seulement vérifiée », et pour la discipline de nommage TAP sur la surface.
* ADR-0021 — sérialiser les tirages sur une source aléatoire ; le correctif de reproductibilité frère (#310 / #311).
