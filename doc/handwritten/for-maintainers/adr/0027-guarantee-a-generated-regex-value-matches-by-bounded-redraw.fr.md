# ADR-0027 | Garantir qu'une valeur regex générée matche son pattern, par redraw borné

🌍 🇫🇷 Français (ce fichier) · 🇬🇧 [English](0027-guarantee-a-generated-regex-value-matches-by-bounded-redraw.md)

**Statut :** Accepté
**Proposé :** 2026-07-27
**Accepté :** 2026-07-31
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0048.**
...
* ADR-0012 — Satisfaire les exclusions de chaînes par un redraw borné : l'idiome que ceci réutilise.
* ADR-0009 — Tirer des chaînes arbitraires depuis un ensemble terminal explicite : la philosophie
