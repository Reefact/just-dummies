# ADR-0027 | Guarantee a generated regex value matches its pattern, by bounded redraw

🌍 🇬🇧 English (this file) · 🇫🇷 [Français](0027-guarantee-a-generated-regex-value-matches-by-bounded-redraw.fr.md)

**Status:** Accepted
**Proposed:** 2026-07-27
**Accepted:** 2026-07-31
**Decision Makers:** Reefact
**Originally recorded in `Reefact/first-class-errors` as ADR-0048.**
...
* **Bounded redraw is the house idiom.** ADR-0012 already meets string exclusions with a bounded redraw:
...
* ADR-0012 — Meet string exclusions with a bounded redraw: the idiom this reuses.
* ADR-0009 — Draw arbitrary strings from an explicit terminal set: the structural, build-don't-filter
