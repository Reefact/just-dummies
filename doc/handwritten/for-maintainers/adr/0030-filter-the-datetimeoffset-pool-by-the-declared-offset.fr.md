# ADR-0030 | Filtrer le pool DateTimeOffset par le décalage déclaré

🌍 🇫🇷 Français (ce fichier) · 🇬🇧 [English](0030-filter-the-datetimeoffset-pool-by-the-declared-offset.md)

**Statut :** Accepté
**Proposé :** 2026-07-28
**Accepté :** 2026-07-28
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0051.**

Supersède l'[ADR-0016](0016-vary-the-datetimeoffset-offset-dimension.fr.md).
...
* **Cela restaure le contrat publié.** `WithOffset` promet que chaque valeur générée porte ce décalage, et c'est
  ...
  pas tirée.
* **Cela conserve la moitié juste de l'ADR-0016.** Une valeur du pool est toujours rendue telle quelle, décalage
  compris : la reconstruire depuis l'instant normaliserait le décalage vers UTC, ce que l'ADR-0016 voulait
...
Envisagée parce que c'est la résolution la moins chère et parce que l'ADR-0016 y était déjà parvenue par le
...
* Passer l'ADR-0016 au statut *Superseded* avec un lien vers celle-ci.
...
* ADR-0016 — Faire varier la dimension d'offset de DateTimeOffset : la décision que celle-ci supersède, et l'entrée
