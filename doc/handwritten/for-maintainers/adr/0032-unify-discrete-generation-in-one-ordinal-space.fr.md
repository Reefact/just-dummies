# ADR-0032 | Unifier la génération discrète dans un espace ordinal unique, avec un moteur dédié seulement là où le substrat arithmétique l'impose

🌍 🇫🇷 Français (ce fichier) · 🇬🇧 [English](0032-unify-discrete-generation-in-one-ordinal-space.md)

**Statut :** Accepté
**Proposé :** 2026-07-28
**Accepté :** 2026-07-28
**Décideurs :** Reefact
**Enregistré à l'origine dans `Reefact/first-class-errors` sous le numéro ADR-0053.**
...
La cible plancher est netstandard2.0 (l'ADR-0007 fixe le plancher .NET Framework sur lequel la bibliothèque
...
* Un tirage discret reste uniforme sur les valeurs de son type, et aucune projection dans l'espace des
  ...
  est une décision distincte, enregistrée dans l'ADR-0031 ; celle-ci ne règle que le fait que la
...
* ADR-0003 — Héberger JustDummies comme paquet autonome dans ce dépôt : la décision d'empaquetage à
...
* ADR-0008 — Générer des chaînes correspondantes depuis un sous-ensemble régulier maison : la décision
  voisine de construire les valeurs constructivement plutôt que par filtrage.
* ADR-0031 — Tirer les nombres arbitraires dans une magnitude ordinaire : la décision voisine qui régit
