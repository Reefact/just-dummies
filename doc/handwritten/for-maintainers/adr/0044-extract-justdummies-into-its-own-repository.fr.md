# ADR-0044 | Extraire JustDummies dans son propre dépôt

🌍 🇫🇷 Français (ce fichier) · 🇬🇧 [English](0044-extract-justdummies-into-its-own-repository.md)

**Statut :** Accepté
**Proposé :** 2026-07-31
**Accepté :** 2026-07-31
**Décideurs :** Reefact
**Supersède :** [ADR-0003](0003-host-dummies-as-a-standalone-package.fr.md) (uniquement son volet colocation — voir ci-dessous)

## Contexte

L'[ADR-0003](0003-host-dummies-as-a-standalone-package.fr.md) décidait deux choses à la fois, et une seule
...
Le premier volet tient et n'est pas remis en cause. Le second était explicitement provisoire : l'ADR-0003
...
l'[ADR-0007](0007-floor-the-library-on-net-framework-4-7-2.fr.md) sont le cas inverse — ils lient les deux
