...
| [ADR-0054](0054-draw-only-valid-values-from-a-typed-builder.md) | Draw only valid values from a typed builder, and judge nothing in a caller-supplied pool | Proposed | recorded here |
