...
🌍 **Langues :**  
🇫🇷 Français (ce fichier) | 🇬🇧 [English](./JD001.en.md)
...
public void A_20_percent_discount_takes_a_fifth_off_the_order() {
    Dummy.Reproducibly(async () => {          // JD001 : le corps async s'exécute en 'async void'
