...
🌍 **Languages:**  
🇬🇧 English (this file) | 🇫🇷 [Français](./JD009.fr.md)
...
```csharp
private static readonly string Tenant = Dummy.String().NonEmpty().Generate();   // JD009: one draw for the whole suite
```
...
* A draw in an instance field initializer or constructor: that is [JD007](JD007.en.md)'s subject when the class is `[Reproducible]`, and outside its scope otherwise.
