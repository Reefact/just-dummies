...
This is the case [ADR-0035](../../for-maintainers/adr/0035-enforce-structural-any-conflicts-at-compile-time.md) names by hand as the one an analyzer should carry and the type system cannot:
...
**Character family.** `Alpha()`, `Numeric()`, `AlphaNumeric()` and `WithChars(...)` validate **every character** of every anchored fragment.
