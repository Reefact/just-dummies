...
The declared count constraints cannot all hold, or the chain asks for more **distinct** elements than its element generator can produce — the cardinality gate [ADR-0013](../../for-maintainers/adr/0013-gate-distinct-collections-by-cardinality-else-bounded-draw.md) records.
