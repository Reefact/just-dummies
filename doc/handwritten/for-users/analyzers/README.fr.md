...
| [JD015 StringConstraintsAdmitNoValue](JD015.fr.md) | 🟠 Avertissement | on | Les contraintes constantes d'une chaîne `AnyString` n'admettent aucune valeur — des fragments ancrés qui ne peuvent pas tenir dans la longueur déclarée, ou une contrainte de caractères qui n'admet aucune valeur d'un value set. |
