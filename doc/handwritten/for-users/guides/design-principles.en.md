...
| sizes stop at one million | a length or count above 1 000 000 is refused | it is past the point where a test wanted a dummy and into the point where it wanted a load test ([ADR-0029](../../for-maintainers/adr/0029-let-a-size-maximum-cap-without-steering-the-draw.md)) |
