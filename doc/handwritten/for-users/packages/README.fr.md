...
| --- | --- | --- |
| [`JustDummies`](./justdummies.fr.md) | la bibliothèque, avec ses 29 règles embarquées | **Oui** — c'est le produit |
...
| [`JustDummies.DiagnosticCatalog`](./justdummies-diagnosticcatalog.fr.md) | les règles `JD001`–`JD029` en constantes vérifiées par le compilateur | Seulement pour supprimer une règle sans littéral de chaîne |
...
```mermaid
flowchart TD
    L["JustDummies<br/><i>la bibliothèque</i>"] -->|"embarque"| A["29 règles<br/><i>analyzers/dotnet/cs</i>"]
