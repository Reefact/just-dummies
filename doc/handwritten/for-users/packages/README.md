...
| --- | --- | --- |
| [`JustDummies`](./justdummies.en.md) | the library, with its 33 rules bundled in | **Yes** — this is the product |
...
| [`JustDummies.DiagnosticCatalog`](./justdummies-diagnosticcatalog.en.md) | the `JD001`–`JD033` rules as compile-checked constants | Only to suppress a rule without a string literal |
