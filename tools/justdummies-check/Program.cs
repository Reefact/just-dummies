...
namespace JustDummiesCheck;

// Packaged-asset compatibility consumer. Run once per consumer TFM by .github/workflows/justdummies.yml.
...
internal static class Program {
    ...
    // Main prints the result as the SEEDBATCH banner. justdummies.yml compares that banner byte-for-byte between the
